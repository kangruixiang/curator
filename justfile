...
docker-curator:
  docker build -t kangruixiang/curator:0.0.3 ./curator
  docker tag kangruixiang/curator:0.0.3 kangruixiang/curator:latest
  docker push kangruixiang/curator:0.0.3
